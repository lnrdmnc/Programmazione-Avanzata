"""
Scrivere nel file esercizio3.py
una classe C per cui accade che ogni volta che si aggiunge una
variabile di istanza ad una delle istanze di C in realta` la variabile viene aggiunta alla classe come variabile di classe.
"""

class C:

    def __setattr__(self, __name: str, __value):
        super().__setattr__(__name,__value) #crea la variabile di classe d' istanza
        setattr(self.__class__, __name, __value)   #crea la variabile di classe
